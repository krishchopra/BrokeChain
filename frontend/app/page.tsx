		...
		<main className="flex min-h-screen flex-col items-center space-y-6 p-12 bg-violet-200">
			...
			<div className="grid grid-cols-2 gap-4 w-full max-w-lg mt-8">
				...
				<GetButton
					...
					apiFn={getSupportedNetworks}
				/>
				<GetButton
					title="getSupportedTokens"
					apiFn={getSupportedTokens}
				/>
				...
				<GetButton
					...
					apiFn={handleReadContract}
				/>
				<GetButton
					title="Read Contract Aptos"
					apiFn={handleReadContractAptos}
				/>
				<button
